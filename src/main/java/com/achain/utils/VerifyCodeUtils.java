...
public class VerifyCodeUtils {
    ...
    public static String createImgCaptcha(int w, int h, String code) throws IOException {
        ByteArrayOutputStream stream = new ByteArrayOutputStream();
        outputImage(w, h, stream, code);
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println(createImgCaptcha(w, h, "1234"));
    }
}
